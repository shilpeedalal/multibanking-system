	...
	<table width="84%" height="696" border="0" align="center"
		...
		<tr>
			...
			<td width="50%" bordercolor="#D6D3CE" bgcolor="white"><p>
					...
					</strong><span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>BE
							PART OF ONLINE BANKING</b>.
					</span>
				</p></td>
			<td width="39%" height="100">

				<table width="100%" height="150px" border="0" cellpadding="0"
					cellspacing="0" bordercolor="#CCCCCC" bgcolor="black">
					<td><image src="bankint.jpg" width="100%" height="150px" /></td>
		...
		<tr>
			<td height="50" colspan="3"><table width="100%" height="50"
					...
					<tr bgcolor="#262626">
						...
						<td class="col_font"><strong><a href="login.jsp">CUSTOMER
									LOGIN</a></strong></td>
						<td class="col_font"><strong><a href="blogin.jsp">EMPLOYEE
									LOGIN</a></strong></td>
						<td class="col_font"><strong><a href="admin.jsp">BANK
									ADMIN</a></strong></td>
						<td class="col_font"><strong><a
								href="loanfacilities.html">LOANS</a></strong></td>
						<td class="col_font"><strong><a
								href="internet banking.html">INTERNET BANKING</a></strong></td>
						<td class="col_font"><strong><a href="aboutus.html">ABOUT
									US</a></strong></td>
					</tr>
				</table>

				<center>
					<BR><BR> <font size="+2" color="#262626"><h2>
									<b>WELCOME TO UNIVERSAL BANKING SERVICES</b>
								</h2></font> <br>




								<form method=post action="logincheck.jsp" name="f"
									...
									<br> <BR> <input type="submit" value="submit">
												...
												value="reset">&nbsp;&nbsp;&nbsp;&nbsp; <input
													...
													onClick="window.location='index.jsp'">
														<center>
															<h2>
																<b><a href="newcustomer.jsp"
																	style="text-decoration: none"><font color="BLACK"><BR>New
																				User..?<image src="signup.gif" /image></font> </a></b>
															</h2>
														</center>
								</form> <br>
				</center>
