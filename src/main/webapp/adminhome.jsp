	...
	<table width="84%" height="696" border="0" align="center"
		...
		<tr>
			...
			<td width="4500%" bordercolor="#D6D3CE" bgcolor="white"><p>
					<span class="style1">UNIVERSAL<br /> NATIONAL<br /> BANK
							...
							behavior="alternate"> <b>WELCOME TO ADMINE MODULE.</b></marquee></span>
				</p></td>
		...
		<tr>
			<td height="50" colspan="3"><table width="100%" height="50"
					...
					<tr bgcolor="black">
						...
						<td class="col_font"><strong><a href="pbreq.jsp"
								style="text-decoration: none"><input type="button"
									value="Pending Banker Request" /></a></strong></td>
						<td class="col_font"><strong><a href="pureq.jsp"
								style="text-decoration: none"><input type="button"
									value="Pending User Request" /></a></strong></td>
						<td class="col_font"><strong><a href="index.jsp"
								style="text-decoration: none"><input type="button"
		...
		<tr>
			<td height="200" colspan="3"><table width="100%" border="0"
					...
					<tr bgcolor="#E4DEDA">
						<td width="31%" height="675" background="indian.jpg"
