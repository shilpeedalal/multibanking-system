	...
	<table width="84%" height="696" border="0" align="center"
		...
		<tr>
			...
			<td width="39%" height="100">
				...
				<table width="100%" height="150px" border="0" cellpadding="0"
					cellspacing="0" bordercolor="#CCCCCC" bgcolor="">
					<tr>
						<td>&nbsp;</td>
					</tr>
		...
		<tr>
			<td height="50" colspan="3"><table width="100%" height="50"
					...
					<tr bgcolor="#262626">
						...
						<td class="col_font"><strong><a href="tsb.jsp"><input
									type="button" value="Transfer to the A/C in SAME Bank" /></a></strong></td>
						<td class="col_font"><strong><a href="tob.jsp"><input
									type="button" value="Transfer to the A/C in OTHER Bank" /></a></strong></td>
		...
		<tr>
			<td height="200" colspan="3"><table width="100%" border="0"
					cellpadding="0" cellspacing="0" background="moneytran.jpg">
					<tr bgcolor="#E4DEDA">
						<td width="31%" height="600" background="moneytran.jpg"
