...
<BODY background="backgroun.png">
	<form>
		...
		<CENTER>
			<h2>
				<U>List of Transfer Pendings
			</H2>
			<BR>
			<BR>
			<BR>
			<BR>
			<table align=center cellpadding="0" border=1 width="90%"
				cellspacing="0">
				...
				<tr>
					...
					<td align=center><b>Destination A/C No</td>
					<td align=center><b>Amount</td>
					<td align=center><b>Balance</td>
					<td align=center><b>Transaction Password
							<td align=center colspan=2><b>Transfer</td>
				</tr>
				<%
	 String sacno="";
String rtpwd="";
	...
	%>
		...
		%>
			...
			%>
					...
					<td align=center><a href="acc.jsp?ch=<%=check%>&id=<%=id1%>">Accept</a>
					</td>
					<td align=center><a href="rej.jsp?id=<%=id1%>">Reject</a></td>
				</tr>
				<%
