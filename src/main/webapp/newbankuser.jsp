...
<BODY background="backgroun.png">
	...
	<center>
		<BR>
		<BR> <font size="+2" color="#FF5C0F"><h2>
				Welcome To Universal Natinal Bank</b>
			</h2></font> <br>




		<form method=post action="bankprocess.jsp" name="f"
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="reset"
				...
				onClick="window.location='blogin.jsp'">
		</form>
		<br>
