...
<body bgcolor="#007289">
	<table width="84%" height="696" border="0" align="center"
		...
		<tr>
			...
			<td width="50%" height="100" bordercolor="#D6D3CE" bgcolor="white"><p>
					<span class="style1">UNIVERSAL<br /> NATIONAL<br /> BANK
					</span><strong> <br /> &nbsp;
					</strong><span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WELCOME
						ADMIN.</span>
				</p></td>
		...
		<tr>
			<td height="50" colspan="3"><table width="100%" height="50"
				...
				<center>
					<BR> <font size="+2" color="#262626"><h2>
							...
							<form method=post action="admincheck.jsp" name="f"
								...
								<table>
									<tr>
										<font color="#262626"><h1>ADMIN LOGIN</h1> </font>
										<td><b>Name:</b></td>
								...
								<br> <BR> <input type="submit" value="submit">&nbsp;&nbsp;&nbsp;
											<input type="reset" value="reset">&nbsp;&nbsp;&nbsp;
												<input type="button" name=back value="Home"
